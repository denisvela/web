...
const Index = () => {
  ...
  return <div className="min-h-screen bg-gray-900 text-white">
      ...
      {/* Sponsors Section */}
      <section className="py-20 text-gray-900 bg-slate-950">
        <div className="max-w-5xl mx-auto px-6">
          <div className="text-center mb-16">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-7 gap-8 items-center my-[7px]">
            <div className="flex justify-center">
            ...
            <div className="flex justify-center py-0 px-[49px] mx-[6px] my-0">
